...
class PerkManager {
  ...
  static const Map<String, PerkDef> defs = {
    ...
    PerkIds.hashBonus: PerkDef(
      ...
      description: '+2% global hash rate per level.',
    ...
    PerkIds.clickBoost: PerkDef(
      ...
      name: 'REFLEX BOOSTER',
      description: '+3% click power per level.',
    ...
    PerkIds.incomeBoost: PerkDef(
      ...
      description: '+2% mining income per level.',
    ...
    PerkIds.clickSingularity: PerkDef(
      ...
      description: '+6% click power per level.',
      icon: Icons.ads_click,
    ),
    PerkIds.incomeSingularity: PerkDef(
      ...
      description: '+6% mining income per level.',
