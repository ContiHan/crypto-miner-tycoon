...
void main() {
  group('Stash System Tests', () {
    ...
    test('Opening Crates', () {
      ...
      expect(game.stashService.ownedArtifacts.values.fold(0, (a, b) => a + b), 1); // 1 Item total
      
      // Buy Premium Crate (50 Chips)
      game.buyCrate(true);
      expect(game.chips, 0);
      expect(game.stashService.ownedArtifacts.values.fold(0, (a, b) => a + b), greaterThanOrEqualTo(2)); // At least 2 items now
